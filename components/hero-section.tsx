          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-2 sm:px-0">
              <Button
                ...
                className="bg-gradient-to-r from-primary to-secondary hover:from-primary/80 hover:to-secondary/80 pulse-glow text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 h-12 sm:h-14 md:h-16 font-heading w-full sm:w-auto"
              >
          ...
          <div className="relative px-2 sm:px-4 lg:px-0 mt-8 lg:mt-0">
            <div className="relative p-2 sm:p-4 md:p-8 rounded-3xl">
              <img
                ...
                className="w-full h-auto max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto rounded-2xl relative z-10 -mt-24 sm:-mt-32 md:-mt-40 lg:-mt-48 transform scale-110 sm:scale-125 md:scale-150"
                style={{
